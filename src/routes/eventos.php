<?php
//require '../src/cloudinary/Cloudinary.php';
...
//));
// TODO: GET para pesquisar eventos por nome, tags , por horas, etc
/*
...
//////////////Alterar um evento///////////////////
$app->put('/api/eventos/{id}/alter', function (Request $request, Response $response) {
