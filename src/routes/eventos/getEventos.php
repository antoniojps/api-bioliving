...
#datas definidas e quais? between
#pesquisar na tabela eventos: nome do evento, local, tags, tipo de evento onde seja igual '%%'
#exemple /api/eventos/pesquisa?msg=random&datainic=//TODO how to send data in query string
$app->get('/api/eventos/pesquisa', function (Request $request, Response $response){
///defaults
#data desde a hora atual até (3000?)
#order by
#order
#
    $byArr = [
